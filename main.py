...
welcome_label = Label(root, text="All--In--One--Login--Tool", font="helvatica 30 bold", fg="#ca2525", bg="#ddd1d1", borderwidth=3, relief=SUNKEN, padx=5)
welcome_label.grid(row=0,column=1,pady=15)

user_name_label = Label(root, text="Username/ Mobile :", font="Symbol 20", bg="#a4ab22", fg="#b03737",borderwidth=2.5, relief=SUNKEN, padx=3, pady=5)
...
pwd_label = Label(root,text="Password :", font="Symbol 20", bg="#a4ab22", fg="#b03737", borderwidth=2.5, relief=SUNKEN, padx=3, pady=5)
